...
public class AttackComponent : MonoBehaviour
{
    ...
    //     활용 시 함수를 재정의해야 합니다.
    List<Component> Attack(ColliderType shape, string attackInfo, LayerMask collisionGroup = default(LayerMask))
    {
        return null;
    }
    //
    ...
    List<Component> Attack(Vector2 size, Vector2 offset, string attackInfo, LayerMask collisionGroup = default(LayerMask))
    {
        return null;
    }
    //
    ...
    List<Component> AttackFrom(Vector2 size, Vector2 position, string attackInfo, LayerMask collisionGroup = default(LayerMask))
    {
        return null;
    }
    //
